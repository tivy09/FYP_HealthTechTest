        ...
        <div class="card mx-4">
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('login') }}" id="login">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <button type="submit" class="btn btn-primary px-4" onclick="event.preventDefault(); localStorage.clear(); sessionStorage.clear(); document.getElementById('login').submit();">
                                {{ trans('global.login') }}
                            </button>
                        </div>
