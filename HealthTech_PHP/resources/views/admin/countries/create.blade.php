    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.countries.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobile_code') ? 'is-invalid' : '' }}" type="text" name="mobile_code" id="mobile_code" value="{{ old('mobile_code', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_active') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', 0) == 1 ? 'checked' : '' }} checked>
...
<script>
    Dropzone.options.iconDropzone = {
        ...
        init: function() {
            @if(isset($currencyList) && $currencyList - > icon)
            var file = {
                !!json_encode($currencyList - > icon) !!
            }
