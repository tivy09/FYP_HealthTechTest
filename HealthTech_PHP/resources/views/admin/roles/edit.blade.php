                                ...
                                <div class="card-body overflow-auto" style="height: 200px;">
                                    @foreach ($permissions as $permission)
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="check2 {{$permission->type}}" name="permissions[]" id="{{ $permission->id }}" value="{{ $permission->id }}" {{ $role->permissions->contains($permission->id) ? 'checked' : '' }}>
